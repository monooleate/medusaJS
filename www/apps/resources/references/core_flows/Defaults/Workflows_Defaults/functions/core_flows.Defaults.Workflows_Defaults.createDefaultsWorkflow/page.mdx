...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/3e617155977e9bfd2f5318a9ab5eedea24664e0c/packages/core/core-flows/src/defaults/workflows/create-defaults.ts#L25" />
